...
-->
		...
		<ul class="nav nav-pills nav-stacked">
			...
			<?php 
			$s=$_SESSION['uname'];
			$qr=mysql_query("select level from admin where uname='$s'");
			while($r=mysql_fetch_array($qr)){
			?>	
			<?php if ($r['level']==1){ ?>
			<li><a href="data_user.php"><span class="glyphicon glyphicon-user"></span>  Data User</a></li>
			<?php }} ?>
			<li><a href="barang.php"><span class="glyphicon glyphicon-briefcase"></span>  Data Barang</a></li>
			<li><a href="barang_laku.php"><span class="glyphicon glyphicon-briefcase"></span>  Data Barang Terjual</a></li>      
			<li><a href="input_data.php"><span class="glyphicon glyphicon-briefcase"></span>  Entry Penjualan</a></li>  			
